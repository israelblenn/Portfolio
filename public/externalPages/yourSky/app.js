...
// Deactivate search button by default
...
function loadMapScenario() {
  ...
  function selectedSuggestion(suggestionResult) {
    ...
    //Allow 3 seconds of loading time after location is picked
    ...
    tl.to(
      ".searchbtn",
      {
        ...
        pointerEvents: "none",
        duration: 0.2,
        onComplete: function reenable() {
          searchbtn.removeAttribute("disabled");
        },
      },
      0
    )
    .set(".searchbtn",{text:"Loading..."}, 0)
    .to(
      ".searchbtn",
      {
        filter: "grayscale(0)",
    ...
    .set(".searchbtn",{text:"Search" + `<img src="media/search.png">`}, 3);
...
function splash() {
  ...
  document.getElementById("splashback").classList.add("fade-out-faster");
